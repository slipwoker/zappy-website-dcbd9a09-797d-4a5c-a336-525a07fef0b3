document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function showError(field, message) {
      ...
      errorEl.style.cssText =
        'display:block;color:#e53e3e;font-size:0.8125rem;margin-top:0.25rem;';
    ...
    function validateField(field) {
      ...
      if (required && value === '') {
        const label = contactForm.querySelector(
          'label[for="' + field.id + '"]'
        );
      ...
      if (value !== '' && (type === 'email' || name.includes('email'))) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (submitBtn) {
        ...
        const original = submitBtn.textContent || submitBtn.value;
  ...
  const SELECTOR =
    '.fade-in, .scroll-animate, [data-animate], .feature-card, .pricing-card, .testimonial-card, .section-header';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'dcbd9a09-797d-4a5c-a336-525a07fef0b3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'dcbd9a09-797d-4a5c-a336-525a07fef0b3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dcbd9a09-797d-4a5c-a336-525a07fef0b3';
